        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JournalID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JournalistId = table.Column<string>(nullable: true),
                    EntryText = table.Column<string>(maxLength: 2000, nullable: false),
                    EntryDate = table.Column<DateTime>(nullable: false),
                    EntryStatus = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entries", x => x.JournalID);
                    table.ForeignKey(
                        name: "FK_Entries_AspNetUsers_JournalistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostTitle = table.Column<string>(maxLength: 20, nullable: false),
                    PostText = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AgendaID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AgendaOwnerId = table.Column<string>(nullable: true),
                    AgendaDate = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedule", x => x.AgendaID);
                    table.ForeignKey(
                        name: "FK_Schedule_AspNetUsers_AgendaOwnerId",
                        column: x => x.AgendaOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunityBoardPostID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Replies", x => x.ReplyID);
                    table.ForeignKey(
                        name: "FK_Replies_Posts_CommunityBoardPostID",
                        column: x => x.CommunityBoardPostID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Replies_CommunityBoardPostID",
                table: "Replies",
                column: "CommunityBoardPostID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedule_AgendaOwnerId",
                table: "Schedule",
                column: "AgendaOwnerId");
        }
